...
document.getElementById("menu-click").addEventListener("click", (event) => {
    openMenu();
});
...
function openMenu() {
    ...
    if (mobileMenu.classList.contains("mmconent-active")) {
        mobileMenu.classList.remove("mmconent-active");
    } else {
        mobileMenu.classList.add("mmconent-active");
    }
    mobileMenu.innerHTML = document.getElementById("sidebar").innerHTML;
}